...
\begin{enumerate}[leftmargin=1.6em, itemsep=0.55em, label=\rank{\arabic*.}]
  ...
  NZD~39,000 industry contract (2018); first-author \textit{Soft Robotics} (2021) and \textit{IEEE TIE} (2021). RoSE cited in \textit{Nature Communications} (2026) biomimetic esophageal motility research.
